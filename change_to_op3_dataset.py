...
for i in tqdm.tqdm(range(198000)):
    ...
    actions[i%20][i//20] = action_load_one_hot[i]
...
for i in range(198000,200000):
    ...
    actions_test[i%20][(i-198000)//20] = action_load_one_hot[i]
